...
*/
	...
	lv_obj_align(dayLED4, lv_scr_act(), LV_ALIGN_CENTER, ((LED_SIZE1)+(LED_SIZE2/2+LED_SPACE_V2)), -(2,5*LED_SIZE2+LED_SPACE_H2/2));		// absolut setzen (LV_ALIGN_IN_LEFT_MID, 5, 5) ist i.O., wenn Zeit noch 20 px höher ->
