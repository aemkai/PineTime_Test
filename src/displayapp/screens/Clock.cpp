...
lv_obj_set_style_local_border_width(minLED2, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, 3);
...
lv_obj_align(hourLED4, minLED1, LV_ALIGN_OUT_BOTTOM_MID, 0, (-2.25*LED_SIZE));	// 1/4 Kreis unter minLED4
