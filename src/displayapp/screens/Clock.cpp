                                           ...
                                           bleController{bleController} 
{
	...
	lv_obj_align(label_date, lv_scr_act(), LV_ALIGN_CENTER, (1.25*LED_SIZE2), 65);
...
*/
	...
	lv_obj_align(monLED3, dayLED3, LV_ALIGN_OUT_BOTTOM_MID, 0, ((LED_SIZE2+LED_SPACE_V2)));	// 1/4 Kreis unter dayLED3	
