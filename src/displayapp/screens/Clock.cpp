...
/****************/
  ...
  lv_arc_set_value(singleArc, 1); //1=gefüllt = Farbe, 0 = ungefüllt = grau)
	
	
	
  singleArc2 = lv_arc_create(lv_scr_act(), nullptr);
  ...
  lv_arc_set_value(singleArc2, 1); //1=gefüllt = Farbe, 0 = ungefüllt = grau)
